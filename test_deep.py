...
def get_estimators_name(estimators):
    result = ['"{}"'.format(estimator.__class__.__name__)
...
if __name__ == "__main__":
    ...
    # estimators = get_best_estimators(True, emotions=emotions)
    ...
    #                                 """)
    # parser.add_argument("-e", "--emotions", help="""Emotions to recognize separated by a comma ',', available emotions are
    ...
    detector = DeepEmotionRecognizer(emotions=emotions, n_rnn_layers=2, n_dense_layers=2, rnn_units=128, dense_units=128)
    # train the model
    detector.train()
